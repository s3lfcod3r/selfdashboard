/** Shared presets for widget toolbar + plugin settings (daysBack / maxAlerts). */
...
export const DAY_PRESET_VALUES = DAY_RANGE_PRESETS.map((p) => p.days)
...
/** Sidebar label for overview alert count (matches daysBack preset). */
