...
import { testImapConnection, fetchUnreadMessagePreviews, markAllUnreadAsRead } from '@/lib/mail/imap'
...
import { accountToImapConfig, clampPollIntervalSeconds, clampUnreadMaxAgeDays } from '@/lib/mail/types'
