...
export const translations = {
  en: {
    ...
    pluginInstallSuccess: 'installed on disk. Click "+ Add" below, then Ctrl+F5 if the widget does not appear.',
  ...
  de: {
    ...
    pluginInstallSuccess: 'auf der Platte installiert. Danach „Hinzufügen“ — oder Strg+F5, falls das Widget fehlt.',
