...
export const translations = {
  en: {
    ...
    uploadPluginZipHint: 'Install plugins from a ZIP (folders with plugin.json + widget.js).',
    ...
    pluginInstallMissingAll: 'Install missing from GitHub',
    pluginsInstalledLocal: 'Ready to add',
    pluginsFromImage: 'Built into Docker image (hybrid)',
    pluginsOnVolume: 'Installed on server (plugin folder)',
    pluginsVolumeEmpty: 'No plugins on disk yet — install from GitHub or upload a ZIP.',
    installPlugin: 'Install',
    installPluginDone: 'Installed',
    pluginInstallSuccess: 'installed on server. Add it below with "+ Add", or press Ctrl+F5 if the widget does not appear.',
    pluginInstallBusy: 'Installing…',
    installPluginHint: 'Download plugin files from GitHub into the mounted folder.',
  ...
  de: {
    ...
    uploadPluginZipHint: 'Plugins aus ZIP installieren (<id>/plugin.json + widget.js).',
    ...
    pluginInstallMissingAll: 'Fehlende von GitHub installieren',
    pluginsInstalledLocal: 'Hinzufügen',
    pluginsFromImage: 'Im Docker-Image (hybrid)',
    pluginsOnVolume: 'Auf dem Server installiert (Plugin-Ordner)',
    pluginsVolumeEmpty: 'Noch keine Plugins auf der Platte — unter „Von GitHub“ installieren oder ZIP hochladen.',
    installPlugin: 'Installieren',
    installPluginDone: 'Installiert',
    pluginInstallSuccess: 'auf dem Server installiert. Unten bei „Auf dem Server installiert“ auf „Hinzufügen“ klicken — oder Strg+F5, falls das Widget fehlt.',
    pluginInstallBusy: 'Installiere…',
    installPluginHint: 'Plugin-Dateien von GitHub in den gemounteten Ordner laden.',
