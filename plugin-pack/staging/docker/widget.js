...
(() => {
  ...
  var meta = {
    id: "docker",
    name: "Docker",
    description: "Docker: kompakte Tabellenansicht oder klassische Zeile. Icons aus Container-Labels + optional CDN (walkxcode/dashboard-icons). Steuerung & Stats konfigurierbar.",
    version: "1.8.10",
  ...
  function Widget({ config, instanceId }) {
    ...
    const latestFetch = (0, import_react4.useRef)(0);
    ...
    const fetchBusyRef = (0, import_react4.useRef)(false);
