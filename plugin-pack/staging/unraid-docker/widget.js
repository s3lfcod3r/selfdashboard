...
(() => {
  ...
  function Widget({ config, instanceId }) {
    ...
    const [statsById, setStatsById] = (0, import_react3.useState)({});
    const [statsErr, setStatsErr] = (0, import_react3.useState)(null);
    ...
    const latest = (0, import_react3.useRef)(0);
    const tableWrapRef = (0, import_react3.useRef)(null);
    ...
    const runMutation = (0, import_react3.useCallback)(
      async (mutation, cid) => {
  ...
  function Settings({ config, onChange }) {
    ...
    const r = config;
    const inp = (0, import_react3.useMemo)(
      () => ({
        background: "var(--surface)",
        border: "1px solid var(--border)",
        color: "var(--text)",
