...
(() => {
  ...
  // plugins-pack/crowdsec/ipLookup.ts
  var LOOKUP_SERVICES = [
    {
      id: "cti",
      label: "CrowdSec CTI",
  ...
  // plugins-pack/crowdsec/presets.ts
  ...
  // plugins-pack/crowdsec/config.ts
  ...
  // plugins-pack/crowdsec/CrowdsecSettings.tsx
  ...
  function CrowdsecSettings({ config, onChange }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "cs-settings", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "Datenbankpfad" : "Database path" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "Zeitraum (Alerts aus DB)" : "Time range (alerts from DB)" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { value: cfg.daysBack, onChange: (e) => onChange("daysBack", Number(e.target.value)), children: DAY_RANGE_PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: p.days, children: de ? p.de : p.en }, p.days)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "Aktualisierung (Sek.)" : "Refresh (sec.)" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "Max. Alerts aus DB" : "Max alerts from DB" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { value: cfg.maxAlerts, onChange: (e) => onChange("maxAlerts", Number(e.target.value)), children: MAX_ALERT_PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: p.value, children: de ? p.de : p.en }, p.value)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { fontSize: 11, color: "var(--text-muted)", margin: "4px 0 0", lineHeight: 1.45 }, children: de ? "\u201EAlle\u201C beim Zeitraum = gesamte Datenbank. \u201EAlle\u201C bei Max. Alerts = kein LIMIT (kann bei sehr gro\xDFen DBs l\xE4nger laden)." : "\u201CAll\u201D time range = entire database. \u201CAll\u201D max alerts = no LIMIT (large DBs may load slower)." }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", style: { flexDirection: "row", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "L\xE4nderliste in der Sidebar dauerhaft anzeigen" : "Always show country list in sidebar" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", style: { flexDirection: "row", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "Entsperren per Docker/cscli" : "Unban via Docker/cscli" })
      ] }),
      cfg.dockerUnban ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "cs-settings-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: de ? "CrowdSec-Container" : "CrowdSec container" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "12px 0 4px", fontSize: 12, color: "var(--text-muted)" }, children: de ? "IP-Lookup-Dienste" : "IP lookup services" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "cs-lookup-grid", children: LOOKUP_SERVICES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
  ...
  // plugins-pack/crowdsec/CrowdsecWidget.tsx
  ...
  // plugins-pack/crowdsec/constants.ts
  var COUNTRY_NAME = {
    DE: "Deutschland",
    US: "USA",
    FR: "Frankreich",
  ...
  // plugins-pack/crowdsec/CountryFlag.tsx
  var import_react3 = __toESM(require_react());

  // plugins-pack/crowdsec/flags.ts
  ...
  // plugins-pack/crowdsec/CrowdsecLogo.tsx
  ...
  function LogoFallback({ height }) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { height, width: height, viewBox: "0 0 64 64", "aria-hidden": true, className: "cs-logo-svg", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("linearGradient", { id: "cs-logo-grad-fb", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "0%", stopColor: "#5eb3ff" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "100%", stopColor: "#2b7fd4" })
      ] }) }),
  ...
  function CrowdsecLogo({ size = 28, variant = "icon" }) {
    ...
    if (failed) {
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LogoFallback, { height: variant === "brand" ? 32 : size });
    }
    if (variant === "brand") {
  ...
  // plugins-pack/crowdsec/IpLookupMenu.tsx
  ...
  function IpLookupMenu({
    ...
    const menu = /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "nav",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { className: "cs-wl-menu-title", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CountryFlag, { code: cc || item.country, size: 16 }),
          ...
          services.map((s) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "a",
            {
              ...
              role: "menuitem",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "cs-wl-menu-icon", "aria-hidden": true, children: s.icon }),
                s.label
              ]
            },
            s.id
          )),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: "cs-wl-menu-close", onClick: onClose, children: [
            "\u2715 ",
            de ? "SCHLIESSEN" : "CLOSE"
          ] })
        ]
  ...
  function CrowdsecWidget({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "section",
      {
        ...
        "data-theme": theme,
        children: [
          error ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "cs-error", children: errLabel(error) }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "cs-split", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("aside", { className: "cs-sidebar", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("header", { className: "cs-brand", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CrowdsecLogo, { variant: "brand" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("nav", { className: "cs-nav", "aria-label": de ? "Navigation" : "Navigation", children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "cs-nav-row", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Shield, { size: 14, strokeWidth: 2.2, "aria-hidden": true }),
                        de ? "\xDCbersicht" : "Overview"
                      ] }),
                      data ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "cs-nav-metrics", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "cs-nav-metric", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-stat cs-nav-stat-compact", children: formatInt(data.alertsInRange, locale) }),
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-sub", children: de ? `Alerts (${alertRangeLabel(cfg.daysBack, true)})` : `Alerts (${alertRangeLabel(cfg.daysBack, false)})` })
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "cs-nav-metric", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-stat cs-nav-stat-compact", children: formatInt(data.activeBans, locale) }),
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-sub", children: de ? "Banns aktiv" : "Active bans" })
                        ] })
                      ] }) : null
                    ]
                  }
                ...
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "cs-nav-row", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Gavel, { size: 14, strokeWidth: 2.2, "aria-hidden": true }),
                        de ? "Banns" : "Bans"
                      ] }),
                      data ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-stat", children: formatInt(data.activeBans, locale) }),
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-sub", children: de ? "Aktive Banns" : "Active bans" })
                      ] }) : null
                    ]
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "cs-nav-row", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Globe, { size: 14, strokeWidth: 2.2, "aria-hidden": true }),
                        de ? "L\xE4nder" : "Countries"
                      ] }),
                      data ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-stat", children: formatInt(data.countryCount, locale) }),
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-nav-sub", children: de ? "alle in DB" : "all in DB" })
                      ] }) : null
                    ]
                  }
                )
              ] }),
              data && (cfg.showCountriesList || tab === "countries") ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("section", { className: `cs-sidebar-extra${cfg.showCountriesList ? " cs-sidebar-extra-pinned" : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("section", { className: "cs-country-list", children: data.countries.slice(0, 40).map((c) => {
                const cc = normalizeCountryCode(c.country) || "??";
                return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("article", { className: "cs-country-row", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CountryFlag, { code: cc, size: 18 }),
                    COUNTRY_NAME[cc] || cc
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "tabular-nums", children: formatInt(c.count, locale) })
                ] }, `${cc}-${c.count}`);
              }) }) }) : null,
              data?.geoip && !data.geoip.enabled ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("section", { className: "cs-range-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "cs-geoip-hint", children: de ? "GeoIP: GeoLite2-*.mmdb fehlt im CrowdSec-Ordner (L\xE4nder/Flaggen)." : "GeoIP: GeoLite2-*.mmdb missing in CrowdSec data folder (countries/flags)." }) }) : null
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "cs-feed-panel", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("header", { className: "cs-feed-toolbar", children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { className: "cs-search-wrap", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Search, { size: 14, strokeWidth: 2, "aria-hidden": true }),
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                    "input",
                    {
                      className: "cs-search",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-feed-count", children: filteredFeed.length })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "cs-feed-list", children: [
                loading && !data && !error ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "cs-loading", children: de ? "Lade\u2026" : "Loading\u2026" }) : null,
                !loading && filteredFeed.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "cs-empty", children: de ? "Keine Eintr\xE4ge im Zeitraum." : "No entries in this period." }) : null,
                filteredFeed.map((item) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                    "article",
                    {
                      ...
                      tabIndex: 0,
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CountryFlag, { code: cc || item.country, size: 20, title: COUNTRY_NAME[cc] || cc }),
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "cs-card-body", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("header", { className: "cs-card-top", children: [
                            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-card-ip", children: item.ip }),
                            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-scenario-tag", title: item.scenario, children: item.scenario }),
                            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "cs-card-time", children: formatRelative(item.time_iso, locale) })
                          ] }),
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                            "span",
                            {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("nav", { className: "cs-card-actions", onClick: (e) => e.stopPropagation(), children: [
                          lookupServices.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                            "button",
                            {
                              type: "button",
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Search, { size: 15, strokeWidth: 2, "aria-hidden": true })
                            }
                          ) : null,
                          cfg.dockerUnban && item.active_ban ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                            "button",
                            {
                              type: "button",
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Trash2, { size: 13, strokeWidth: 2, "aria-hidden": true })
                            }
                          ) : null,
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                            "button",
                            {
                              ...
                              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Copy, { size: 14, strokeWidth: 2, "aria-hidden": true })
                            }
                          )
                        ] })
                      ]
          ...
          lookupItem && lookupServices.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            IpLookupMenu,
            {
              item: lookupItem,
              de,
          ...
          unbanPending ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("section", { className: "cs-confirm-overlay", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("article", { className: "cs-confirm-box", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { style: { margin: 0 }, children: de ? `Sperre f\xFCr ${unbanPending.ip} per cscli im Container \u201E${cfg.crowdsecContainer}" aufheben?` : `Remove ban for ${unbanPending.ip} via cscli in container "${cfg.crowdsecContainer}"?` }),
            unbanMsg ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { style: { margin: "8px 0 0", color: "#ef4444", fontSize: 10 }, children: unbanMsg }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("nav", { className: "cs-confirm-actions", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "button",
                {
                  type: "button",
  ...
  // plugins-pack/crowdsec/index.tsx
  ...
  function Widget({ config, layoutMode, theme }) {
    const locale = useDashboardStore((s) => s.locale);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CrowdsecWidget, { config, locale, layoutMode, theme });
  }
  var component = {
    Widget,
