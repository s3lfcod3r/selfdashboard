...
(() => {
  ...
  function LogoFallback({ height }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { height, width: height, viewBox: "0 0 64 64", "aria-hidden": true, className: "csv2-logo-svg", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", { id: "csv2-logo-grad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "32", cy: "32", r: "30", fill: "currentColor", fillOpacity: "0.12", stroke: "url(#csv2-logo-grad)", strokeWidth: "2" }),
  ...
  function CrowdsecLogo({ variant = "brand" }) {
    ...
    if (failed) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogoFallback, { height: variant === "brand" ? 32 : 24 });
    if (variant === "brand") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src, alt: "", width: 24, height: 24, className: "csv2-logo-img", decoding: "async", onError: () => setFailed(true) });
  }
  ...
  function formatCompact(n, locale) {
    ...
    if (abs >= 1e6) return `${(n / 1e6).toLocaleString(locale === "en" ? "en-GB" : "de-DE", { maximumFractionDigits: 1 })}M`;
    if (abs >= 1e3) return `${(n / 1e3).toLocaleString(locale === "en" ? "en-GB" : "de-DE", { maximumFractionDigits: 1 })}k`;
  ...
  function Sidebar({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("aside", { className: "csv2-sidebar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("header", { className: "csv2-brand", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CrowdsecLogo, { variant: "brand" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: `csv2-status-pill${online ? " csv2-status-online" : ""}`, children: online ? de ? "\u2713 Aktiv & gesch\xFCtzt" : "\u2713 Active & protected" : de ? "Offline" : "Offline" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("nav", { className: "csv2-nav", "aria-label": de ? "Navigation" : "Navigation", children: NAV.map(({ id, icon: Icon2, de: labelDe, en: labelEn, stub }) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "button",
        {
          type: "button",
          ...
          onClick: () => onTab(id),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "csv2-nav-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Icon2, { size: 14, strokeWidth: 2.2, "aria-hidden": true }),
              de ? labelDe : labelEn
            ] }),
            id === "overview" && data && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-stat", children: formatInt(data.alertsInRange, locale) }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-sub", children: de ? `Alerts (${alertRangeLabel(daysBack, true)})` : `Alerts (${alertRangeLabel(daysBack, false)})` })
            ] }),
            id === "decisions" && data && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-stat", children: formatInt(localBans, locale) }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-sub", children: de ? "Lokal aktiv" : "Local active" })
            ] }),
            id === "countries" && data && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-stat", children: formatInt(data.countryCount, locale) }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "csv2-nav-sub", children: de ? "in DB" : "in DB" })
            ] })
          ]
        },
        id
      )) }),
      (tab === "countries" || tab === "overview") && data && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("section", { className: "csv2-sidebar-countries", children: data.countries.slice(0, 8).map((c) => {
        const cc = normalizeCountryCode(c.country) || "??";
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "csv2-country-row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CountryFlag, { code: cc, size: 14 }),
            COUNTRY_NAME[cc] || cc
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "tabular-nums", children: formatInt(c.count, locale) })
        ] }, `${cc}-${c.count}`);
      }) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("footer", { className: "csv2-sidebar-footer", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Zap, { size: 12, "aria-hidden": true }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "SelfDashboard" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `csv2-dot${online ? " csv2-dot-on" : ""}` }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: de ? "Online" : "Online" })
      ] })
    ] });
  }
  ...
  function WorldMap({
    ...
    const markers = (0, import_react5.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: "csv2-map", viewBox: `0 0 ${W} ${H}`, preserveAspectRatio: "xMidYMid meet", "aria-label": "Attack map", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("radialGradient", { id: "csv2-map-bg", cx: "50%", cy: "50%", r: "70%", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("stop", { offset: "0%", stopColor: "color-mix(in srgb, var(--accent) 8%, var(--surface))" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("stop", { offset: "100%", stopColor: "var(--surface-2)" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { width: W, height: H, fill: "url(#csv2-map-bg)", rx: "8" }),
      [0, 1, 2, 3].map((i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "line",
        {
          x1: 0,
          y1: H / 4 * i,
      ...
      [0, 1, 2, 3, 4, 5, 6].map((i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "line",
        {
          x1: W / 6 * i,
          y1: 0,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ellipse", { cx: W * 0.52, cy: H * 0.48, rx: W * 0.42, ry: H * 0.38, fill: "color-mix(in srgb, var(--accent) 6%, transparent)" }),
      markers.map((m) => {
        const active = hi === m.cc;
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("g", { className: "csv2-map-dot-wrap", onClick: () => onSelectCountry?.(m.cc), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "circle",
          {
            cx: m.x,
            cy: m.y,
      ...
      hiMarker && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: hiMarker.x, cy: hiMarker.y, r: 12, className: "csv2-map-pulse" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: hiMarker.x, cy: hiMarker.y, r: 3.5, fill: "var(--csv2-ban)" })
      ] })
    ] });
  }
  ...
  function FeedTable({
    ...
    if (items.length === 0) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "csv2-empty", children: de ? "Keine Eintr\xE4ge." : "No entries." });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "csv2-table-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("table", { className: "csv2-table", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "Status" : "Status" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "IP" : "IP" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "Herkunft" : "Origin" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "Angriffsart" : "Attack type" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "Zeit" : "Time" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("th", { children: de ? "Aktionen" : "Actions" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("tbody", { children: items.map((item) => {
        const cc = normalizeCountryCode(item.country);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: item.active_ban ? "csv2-badge csv2-badge-ban" : "csv2-badge csv2-badge-alert", children: item.active_ban ? de ? "GEBANNT" : "BANNED" : "ALERT" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { className: "csv2-cell-ip", children: item.ip }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("td", { className: "csv2-cell-origin", children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CountryFlag, { code: cc || item.country, size: 16 }),
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: COUNTRY_NAME[cc] || cc || "?" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { className: "csv2-cell-scenario", title: item.scenario, children: item.scenario }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("td", { className: "csv2-cell-time", children: formatRelative(item.time_iso, locale) }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("td", { className: "csv2-cell-actions", onClick: (e) => e.stopPropagation(), children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "csv2-icon-btn", title: de ? "IP-Lookup" : "IP lookup", onClick: (e) => onLookup(item, e.currentTarget), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Search, { size: 14 }) }),
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "csv2-icon-btn", title: de ? "Auf Karte zoomen" : "Zoom map", onClick: () => onMapZoom(item), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Crosshair, { size: 14 }) }),
                dockerUnban && item.active_ban && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "csv2-icon-btn csv2-icon-btn-danger", disabled: unbanBusy, title: de ? "Entsperren" : "Unban", onClick: () => onUnban(item), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Trash2, { size: 13 }) }),
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "csv2-icon-btn", title: de ? "IP kopieren" : "Copy IP", onClick: () => onCopy(item.ip), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Copy, { size: 13 }) })
              ] })
            ]
          },
          key
  ...
  function IpLookupMenu({
    ...
    const cc = normalizeCountryCode(item.country);
    const menu = /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { ref: menuRef, className: "csv2-wl-menu", role: "menu", style: { left: pos.left, top: pos.top }, onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "csv2-wl-menu-title", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CountryFlag, { code: cc || item.country, size: 16 }),
      ...
      services.map((s) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { className: "csv2-wl-menu-item", href: s.href(item), target: "_blank", rel: "noopener noreferrer", role: "menuitem", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "csv2-wl-menu-icon", "aria-hidden": true, children: s.icon }),
        s.label
      ] }, s.id)),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "csv2-wl-menu-close", onClick: onClose, children: [
        "\u2715 ",
        de ? "SCHLIESSEN" : "CLOSE"
      ] })
    ] });
  ...
  function CrowdsecV2Widget({ config: raw, locale, layoutMode = "desktop", theme = "dark" }) {
    const de = locale !== "en";
    ...
    const fetchData = (0, import_react7.useCallback)(async () => {
      ...
      try {
        const json = await pluginApiJson("crowdsec-v2", `/?${params}`, { timeoutMs: 5e4 });
        setData(json);
        setError(null);
      } catch (e) {
    ...
    const zoomMap = (item) => {
      const cc = normalizeCountryCode(item.country);
      if (cc) setMapHighlight(cc);
      setSelectedKey(`${item.alertId}-${item.ip}`);
    };
    const showStub = tab === "scenarios" || tab === "bouncers" || tab === "about";
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("section", { className: `csv2-widget ${layoutClass} csv2-theme-${theme}`.trim(), "data-theme": theme, style: { position: "relative" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "csv2-split", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Sidebar, { tab, onTab: setTab, data, daysBack: cfg.daysBack, locale, online: !error && Boolean(data) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("section", { className: "csv2-main", children: showStub ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "csv2-stub", children: de ? "Dieser Bereich folgt in einer sp\xE4teren Version. Nutze \xDCbersicht, Entscheidungen oder L\xE4nder." : "This section comes in a later version. Use Overview, Decisions or Countries." }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
          ...
          data && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("section", { className: "csv2-map-wrap", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            WorldMap,
            {
              ...
              onSelectCountry: (cc) => setMapHighlight(cc)
            }
          ) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("footer", { className: "csv2-footer", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("button", { type: "button", className: "csv2-refresh-btn", onClick: () => void fetchData(), disabled: loading, children: [
      ...
      unbanPending && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("section", { className: "csv2-confirm-overlay", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("article", { className: "csv2-confirm-box", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("nav", { className: "csv2-confirm-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: "csv2-btn-ghost", onClick: () => setUnbanPending(null), disabled: unbanBusy, children: de ? "Abbrechen" : "Cancel" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", className: "csv2-btn-danger", disabled: unbanBusy, onClick: () => void doUnban(unbanPending), children: unbanBusy ? "\u2026" : de ? "Entsperren" : "Unban" })
        ] })
      ] }) })
    ] });
  }
  ...
  function CrowdsecV2Settings({ config, onChange }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "csv2-settings", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "text", value: cfg.dbPath, onChange: (e) => onChange("dbPath", e.target.value), placeholder: "/crowdsec-data/crowdsec.db" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "number", min: 5, max: 600, value: cfg.refreshSeconds, onChange: (e) => onChange("refreshSeconds", Number(e.target.value)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row csv2-settings-check", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "checkbox", checked: cfg.dockerUnban, onChange: (e) => onChange("dockerUnban", e.target.checked) }),
      ...
      cfg.dockerUnban && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { className: "csv2-settings-row", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { type: "text", value: cfg.crowdsecContainer, onChange: (e) => onChange("crowdsecContainer", e.target.value), placeholder: "crowdsec" })
      ] }),
